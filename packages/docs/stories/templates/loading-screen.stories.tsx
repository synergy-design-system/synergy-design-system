...
const meta: Meta = {
  ...
  tags: ['Loading Screen', 'Feedback'],
  title: 'Templates/Loading Screen',
};
export default meta;

export const LoadingScreenLightTheme: Story = {
  parameters: {
    chromatic: {
      modes: {
        [SICK_2025_LIGHT]: Chromatic_Modes_Sick_2025[SICK_2025_LIGHT],
      },
    },
    docs: {
      description: {
        story: generateStoryDescription('loading-screen', 'light-mode', 'templates'),
      },
    },
  },
  render: () => html`
...
export const LoadingScreenDarkTheme: Story = {
  parameters: {
    chromatic: {
      modes: {
        [SICK_2025_DARK]: Chromatic_Modes_Sick_2025[SICK_2025_DARK],
      },
    },
    docs: {
      description: {
        story: generateStoryDescription('loading-screen', 'dark-mode', 'templates'),
      },
    },
  },
  render: () => html`

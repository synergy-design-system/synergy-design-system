...
type SynBreadcrumbEvents = [];

type SynBreadcrumbItemEvents = [];

type SynButtonEvents = [
  ['syn-blur', SynBlurEvent],
  ['syn-focus', SynFocusEvent],
  ['syn-invalid', SynInvalidEvent],
];

type SynButtonGroupEvents = [];

type SynCardEvents = [];

type SynChartEvents = [];

type SynCheckboxEvents = [
  ['syn-blur', SynBlurEvent],
...
type SynCheckboxGroupEvents = [];

type SynComboboxEvents = [
  ['syn-change', SynChangeEvent],
...
type SynDividerEvents = [];

type SynDrawerEvents = [
  ['syn-show', SynShowEvent],
  ['syn-after-show', SynAfterShowEvent],
  ['syn-hide', SynHideEvent],
  ['syn-after-hide', SynAfterHideEvent],
...
type SynIconEvents = [['syn-load', SynLoadEvent], ['syn-error', SynErrorEvent]];

type SynIconButtonEvents = [
  ['syn-blur', SynBlurEvent],
  ['syn-focus', SynFocusEvent],
];
...
type SynMenuEvents = [['syn-select', SynSelectEvent]];

type SynMenuItemEvents = [];

type SynMenuLabelEvents = [];

type SynNavItemEvents = [
  ['syn-show', SynShowEvent],
  ['syn-hide', SynHideEvent],
  ['syn-blur', SynBlurEvent],
  ['syn-focus', SynFocusEvent],
...
type SynOptgroupEvents = [];

type SynOptionEvents = [];

type SynPaginationEvents = [
...
type SynPopupEvents = [['syn-reposition', SynRepositionEvent]];

type SynPrioNavEvents = [];

type SynProgressBarEvents = [];

type SynProgressRingEvents = [];
...
type SynRadioButtonEvents = [
  ['syn-blur', SynBlurEvent],
  ['syn-focus', SynFocusEvent],
];

type SynRadioGroupEvents = [
  ['syn-change', SynChangeEvent],
  ['syn-input', SynInputEvent],
  ['syn-invalid', SynInvalidEvent],
];
...
type SynRangeTickEvents = [];

type SynSelectEvents = [
  ['syn-change', SynChangeEvent],
  ['syn-clear', SynClearEvent],
  ['syn-input', SynInputEvent],
  ['syn-focus', SynFocusEvent],
...
type SynSpinnerEvents = [];

type SynSwitchEvents = [
  ['syn-blur', SynBlurEvent],
  ['syn-change', SynChangeEvent],
  ['syn-input', SynInputEvent],
  ['syn-focus', SynFocusEvent],
...
type SynTabEvents = [['syn-close', SynCloseEvent]];

type SynTabGroupEvents = [
  ['syn-tab-show', SynTabShowEvent],
  ['syn-tab-hide', SynTabHideEvent],
];

type SynTabPanelEvents = [];

type SynTagEvents = [['syn-remove', SynRemoveEvent]];

type SynTagGroupEvents = [];

type SynTextareaEvents = [
  ['syn-blur', SynBlurEvent],
  ['syn-change', SynChangeEvent],
  ['syn-focus', SynFocusEvent],
  ['syn-input', SynInputEvent],
...
declare module 'vue' {
  interface GlobalComponents {
     ...
     */ 'syn-alert': SynVueElement<SynAlert, SynAlertEvents>;
    /**
     ...
     *
     * @csspart base - The component's base wrapper.
     */ 'syn-badge': SynVueElement<SynBadge, SynBadgeEvents>;
    /**
     ...
     *
     * @csspart base - The component's base wrapper.
     */ 'syn-breadcrumb': SynVueElement<SynBreadcrumb, SynBreadcrumbEvents>;
    /**
     ...
     */ 'syn-breadcrumb-item': SynVueElement<
      SynBreadcrumbItem,
      SynBreadcrumbItemEvents
    >;
    /**
     ...
     */ 'syn-button': SynVueElement<SynButton, SynButtonEvents>;
    /**
     ...
     *
     * @csspart base - The component's base wrapper.
     */ 'syn-button-group': SynVueElement<SynButtonGroup, SynButtonGroupEvents>;
    /**
     ...
     */ 'syn-card': SynVueElement<SynCard, SynCardEvents>;
    /**
     ...
     *
     * @csspart base - The component's base wrapper.
     */ 'syn-chart': SynVueElement<SynChart, SynChartEvents>;
    /**
     ...
     */ 'syn-checkbox': SynVueElement<SynCheckbox, SynCheckboxEvents>;
    /**
     ...
     * @csspart form-control-help-text - The help text's wrapper.
     */ 'syn-checkbox-group': SynVueElement<
      SynCheckboxGroup,
      SynCheckboxGroupEvents
    >;
    /**
     ...
     */ 'syn-combobox': SynVueElement<SynCombobox, SynComboboxEvents>;
    /**
     ...
     */ 'syn-dialog': SynVueElement<SynDialog, SynDialogEvents>;
    /**
     ...
     */ 'syn-divider': SynVueElement<SynDivider, SynDividerEvents>;
    /**
     ...
     *   trapping and allow third-party modals spawned from an active Synergy modal, call `modal.activateExternal()` when
     *   the third-party modal opens. Upon closing, call `modal.deactivateExternal()` to restore Synergy's focus trapping.
     */ 'syn-drawer': SynVueElement<SynDrawer, SynDrawerEvents>;
    /**
     ...
     */ 'syn-dropdown': SynVueElement<SynDropdown, SynDropdownEvents>;
    /**
     ...
     */ 'syn-fieldset': SynVueElement<SynFieldset, SynFieldsetEvents>;
    /**
     ...
     * when a file is dropped
     */ 'syn-file': SynVueElement<SynFile, SynFileEvents>;
    /**
     ...
     */ 'syn-header': SynVueElement<SynHeader, SynHeaderEvents>;
    /**
     ...
     */ 'syn-icon': SynVueElement<SynIcon, SynIconEvents>;
    /**
     ...
     *
     * @csspart base - The component's base wrapper.
     */ 'syn-icon-button': SynVueElement<SynIconButton, SynIconButtonEvents>;
    /**
     ...
     */ 'syn-input': SynVueElement<SynInput, SynInputEvents>;
    /**
     ...
     */ 'syn-menu': SynVueElement<SynMenu, SynMenuEvents>;
    /**
     ...
     */ 'syn-menu-item': SynVueElement<SynMenuItem, SynMenuItemEvents>;
    /**
     ...
     */ 'syn-menu-label': SynVueElement<SynMenuLabel, SynMenuLabelEvents>;
    /**
     ...
     */ 'syn-nav-item': SynVueElement<SynNavItem, SynNavItemEvents>;
    /**
     ...
     *
     * @cssproperty --display-divider - Display property of the divider. Defaults to "block"
     */ 'syn-optgroup': SynVueElement<SynOptgroup, SynOptgroupEvents>;
    /**
     ...
     * @csspart prefix - The container that wraps the prefix.
     * @csspart suffix - The container that wraps the suffix.
     */ 'syn-option': SynVueElement<SynOption, SynOptionEvents>;
    /**
     ...
     */ 'syn-pagination': SynVueElement<SynPagination, SynPaginationEvents>;
    /**
     ...
     *  popup can be before overflowing. Useful for positioning child elements that need to overflow. This property is only
     *  available when using `auto-size`.
     */ 'syn-popup': SynVueElement<SynPopup, SynPopupEvents>;
    /**
     ...
     *
     */ 'syn-prio-nav': SynVueElement<SynPrioNav, SynPrioNavEvents>;
    /**
     ...
     */ 'syn-progress-bar': SynVueElement<SynProgressBar, SynProgressBarEvents>;
    /**
     ...
     */ 'syn-progress-ring': SynVueElement<
      SynProgressRing,
      SynProgressRingEvents
    >;
    /**
     ...
     */ 'syn-radio': SynVueElement<SynRadio, SynRadioEvents>;
    /**
     ...
     * @csspart suffix - The container that wraps the suffix.
     */ 'syn-radio-button': SynVueElement<SynRadioButton, SynRadioButtonEvents>;
    /**
     ...
     */ 'syn-radio-group': SynVueElement<SynRadioGroup, SynRadioGroupEvents>;
    /**
     ...
     */ 'syn-range': SynVueElement<SynRange, SynRangeEvents>;
    /**
     ...
     */ 'syn-range-tick': SynVueElement<SynRangeTick, SynRangeTickEvents>;
    /**
 ...
 */ 'syn-side-nav': SynVueElement<SynSideNav, SynSideNavEvents>;
    /**
     ...
     */ 'syn-spinner': SynVueElement<SynSpinner, SynSpinnerEvents>;
    /**
     ...
     */ 'syn-switch': SynVueElement<SynSwitch, SynSwitchEvents>;
    /**
     ...
     * @csspart close-button - The close button, an `<syn-icon-button>`.
     * @csspart close-button__base - The close button's exported `base` part.
     */ 'syn-tab': SynVueElement<SynTab, SynTabEvents>;
    /**
     ...
     */ 'syn-tab-group': SynVueElement<SynTabGroup, SynTabGroupEvents>;
    /**
     ...
     */ 'syn-tab-panel': SynVueElement<SynTabPanel, SynTabPanelEvents>;
    /**
     ...
     */ 'syn-tag': SynVueElement<SynTag, SynTagEvents>;
    /**
     ...
     */ 'syn-tag-group': SynVueElement<SynTagGroup, SynTagGroupEvents>;
    /**
     ...
     */ 'syn-textarea': SynVueElement<SynTextarea, SynTextareaEvents>;
    /**
     ...
     */ 'syn-tooltip': SynVueElement<SynTooltip, SynTooltipEvents>;
    /**
     ...
     */ 'syn-validate': SynVueElement<SynValidate, SynValidateEvents>;
  }
  ...
  interface IntrinsicElementAttributes {
     ...
     * @animation alert.show - The animation to use when showing the alert.
     * @animation alert.hide - The animation to use when hiding the alert.
     */ 'syn-alert': SynIntrinsicElement<SynAlert, SynAlertEvents>;
    /**
     * @summary Badges are used to draw attention and display statuses or counts.
     * @documentation https://synergy-design-system.github.io/?path=/docs/components-syn-badge--docs
     * @status stable
     ...
     *
     * @csspart base - The component's base wrapper.
     */ 'syn-badge': SynIntrinsicElement<SynBadge, SynBadgeEvents>;
    /**
     * @summary Breadcrumbs provide a group of links so users can easily navigate a website's hierarchy.
     * @documentation https://synergy-design-system.github.io/?path=/docs/components-syn-breadcrumb--docs
     * @status stable
     ...
     *
     * @csspart base - The component's base wrapper.
     */ 'syn-breadcrumb': SynIntrinsicElement<
      SynBreadcrumb,
      SynBreadcrumbEvents
    >;
    /**
     ...
     * @csspart suffix - The container that wraps the suffix.
     * @csspart separator - The container that wraps the separator.
     */ 'syn-breadcrumb-item': SynIntrinsicElement<
      SynBreadcrumbItem,
      SynBreadcrumbItemEvents
    >;
    /**
     ...
     * @csspart caret - The button's caret icon, an `<syn-icon>` element.
     * @csspart spinner - The spinner that shows when the button is in the loading state.
     */ 'syn-button': SynIntrinsicElement<SynButton, SynButtonEvents>;
    /**
     * @summary Button groups can be used to group related buttons into sections.
     * @documentation https://synergy-design-system.github.io/?path=/docs/components-syn-button-group--docs
     * @status stable
     ...
     *
     * @csspart base - The component's base wrapper.
     */ 'syn-button-group': SynIntrinsicElement<
      SynButtonGroup,
      SynButtonGroupEvents
    >;
    /**
     * @summary Cards can be used to group related subjects in a container.
     * @documentation https://synergy-design-system.github.io/?path=/docs/components-syn-card--docs
     ...
     * @cssproperty --border-width - The width of the card's borders.
     * @cssproperty --padding - The padding to use for the card's sections.
     */ 'syn-card': SynIntrinsicElement<SynCard, SynCardEvents>;
    /**
     * @summary The `<syn-chart>` component is a container for displaying charts. It provides a structured layout and styling for chart elements, allowing for consistent presentation across different types of charts. The chart component is based on [Apache ECharts](https://echarts.apache.org)
     *
     * @documentation https://synergy-design-system.github.io/?path=/docs/charting-syn-chart--docs
     ...
     *
     * @csspart base - The component's base wrapper.
     */ 'syn-chart': SynIntrinsicElement<SynChart, SynChartEvents>;
    /**
     * @summary Checkboxes allow the user to toggle an option on or off.
     * @documentation https://synergy-design-system.github.io/?path=/docs/components-syn-checkbox--docs
     * @status stable
     ...
     * @csspart label - The container that wraps the checkbox's label.
     * @csspart form-control-help-text - The help text's wrapper.
     */ 'syn-checkbox': SynIntrinsicElement<SynCheckbox, SynCheckboxEvents>;
    /**
     * @summary Checkbox groups are used to group multiple checkboxes together.
     * @documentation https://synergy-design-system.github.io/?path=/docs/components-syn-checkbox-group--docs
     * @status stable
     ...
     * @csspart form-control-input - The input's wrapper.
     * @csspart form-control-help-text - The help text's wrapper.
     */ 'syn-checkbox-group': SynIntrinsicElement<
      SynCheckboxGroup,
      SynCheckboxGroupEvents
    >;
    /**
     ...
     * @animation combobox.show - The animation to use when showing the combobox.
     * @animation combobox.hide - The animation to use when hiding the combobox.
     */ 'syn-combobox': SynIntrinsicElement<SynCombobox, SynComboboxEvents>;
    /**
     * @summary Details show a brief summary and expand to show additional content.
     * @documentation https://synergy-design-system.github.io/?path=/docs/components-syn-details--docs
     * @status stable
     ...
     *   trapping and allow third-party modals spawned from an active Synergy modal, call `modal.activateExternal()` when
     *   the third-party modal opens. Upon closing, call `modal.deactivateExternal()` to restore Synergy's focus trapping.
     */ 'syn-dialog': SynIntrinsicElement<SynDialog, SynDialogEvents>;
    /**
     * @summary Dividers are used to visually separate or group elements.
     * @documentation https://synergy-design-system.github.io/?path=/docs/components-syn-divider--docs
     * @status stable
     ...
     * @cssproperty --width - The width of the divider.
     * @cssproperty --spacing - The spacing of the divider.
     */ 'syn-divider': SynIntrinsicElement<SynDivider, SynDividerEvents>;
    /**
     * @summary Drawers slide in from a container to expose additional options and information.
     * @documentation https://synergy-design-system.github.io/?path=/docs/components-syn-drawer--docs
     * @status stable
     ...
     *   trapping and allow third-party modals spawned from an active Synergy modal, call `modal.activateExternal()` when
     *   the third-party modal opens. Upon closing, call `modal.deactivateExternal()` to restore Synergy's focus trapping.
     */ 'syn-drawer': SynIntrinsicElement<SynDrawer, SynDrawerEvents>;
    /**
     * @summary Dropdowns expose additional content that "drops down" in a panel.
     * @documentation https://synergy-design-system.github.io/?path=/docs/components-syn-dropdown--docs
     * @status stable
     ...
     * @animation dropdown.show - The animation to use when showing the dropdown.
     * @animation dropdown.hide - The animation to use when hiding the dropdown.
     */ 'syn-dropdown': SynIntrinsicElement<SynDropdown, SynDropdownEvents>;
    /**
     * @summary Fieldsets are used to group related elements in a form.
     * @documentation https://synergy-design-system.github.io/?path=/docs/components-syn-fieldset--docs
     * @status stable
     ...
     *
     * @cssproperty --item-gap - The gap between the fields in the fieldset. Defaults to `--syn-spacing-large`
     */ 'syn-fieldset': SynIntrinsicElement<SynFieldset, SynFieldsetEvents>;
    /**
     * @summary File controls allow selecting an arbitrary number of files for uploading.
     * @documentation https://synergy-design-system.github.io/?path=/docs/components-syn-file--docs
     * @status stable
     ...
     * @animation file.text.appear - The appear animation to use for the file placeholder text
     * when a file is dropped
     */ 'syn-file': SynIntrinsicElement<SynFile, SynFileEvents>;
    /**
     * @summary The <syn-header /> element provides a generic application header
     * that can be used to add applications name, toolbar and primary navigation.
     *
     ...
     * @cssproperty --sticky-position - The position of the sticky header from the top of the viewport. Defaults to the top of the screen.
     * @cssproperty --metanavigation-item-size - The size of the items in the meta navigation. Also used for the height of dividers in the meta navigation. Defaults to var(--syn-font-size-x-large)
     */ 'syn-header': SynIntrinsicElement<SynHeader, SynHeaderEvents>;
    /**
     * @summary Icons are symbols that can be used to represent various options within an application.
     * @documentation https://synergy-design-system.github.io/?path=/docs/components-syn-icon--docs
     * @status stable
     ...
     * @csspart svg - The internal SVG element.
     * @csspart use - The <use> element generated when using `spriteSheet: true`
     */ 'syn-icon': SynIntrinsicElement<SynIcon, SynIconEvents>;
    /**
     * @summary Icons buttons are simple, icon-only buttons that can be used for actions and in toolbars.
     * @documentation https://synergy-design-system.github.io/?path=/docs/components-syn-icon-button--docs
     * @status stable
     ...
     *
     * @csspart base - The component's base wrapper.
     */ 'syn-icon-button': SynIntrinsicElement<
      SynIconButton,
      SynIconButtonEvents
    >;
    /**
     ...
     * @cssproperty --syn-input-autofill-text-fill-color - The text fill color to apply when the input is autofilled.
     * @cssproperty --syn-input-autofill-caret-color - The caret color to apply when the input is autofilled.
     */ 'syn-input': SynIntrinsicElement<SynInput, SynInputEvents>;
    /**
     * @summary Menus provide a list of options for the user to choose from.
     * @documentation https://synergy-design-system.github.io/?path=/docs/components-syn-menu--docs
     * @status stable
     ...
     *
     * @event {{ item: SynMenuItem }} syn-select - Emitted when a menu item is selected.
     */ 'syn-menu': SynIntrinsicElement<SynMenu, SynMenuEvents>;
    /**
     * @summary Menu items provide options for the user to pick from in a menu.
     * @documentation https://synergy-design-system.github.io/?path=/docs/components-syn-menu-item--docs
     * @status stable
     ...
     *
     * @cssproperty [--submenu-offset=-2px] - The distance submenus shift to overlap the parent menu.
     */ 'syn-menu-item': SynIntrinsicElement<SynMenuItem, SynMenuItemEvents>;
    /**
     * @summary Menu labels are used to describe a group of menu items.
     * @documentation https://synergy-design-system.github.io/?path=/docs/components-syn-menu-label--docs
     * @status stable
     ...
     *
     * @cssproperty --display-divider - Display property of the divider. Defaults to "block"
     */ 'syn-menu-label': SynIntrinsicElement<SynMenuLabel, SynMenuLabelEvents>;
    /**
     * @summary Flexible button / link component that can be used to quickly build navigations.
     * @documentation https://synergy-design-system.github.io/?path=/docs/components-syn-nav-item--docs
     * Takes one of 3 forms:
     ...
     * @cssproperty --indentation-stepping - The amount of pixels each level will indent.
     * @cssproperty --display-children - Display property of the children. Defaults to "contents"
     */ 'syn-nav-item': SynIntrinsicElement<SynNavItem, SynNavItemEvents>;
    /**
     * @summary The <syn-optgroup> element creates a grouping for <syn-option>s within a <syn-select>.
     * @documentation https://synergy-design-system.github.io/?path=/docs/components-syn-optgroup--docs
     * @status stable
     ...
     *
     * @cssproperty --display-divider - Display property of the divider. Defaults to "block"
     */ 'syn-optgroup': SynIntrinsicElement<SynOptgroup, SynOptgroupEvents>;
    /**
     * @summary Options define the selectable items within various form controls such as [select](/components/select).
     * @documentation https://synergy-design-system.github.io/?path=/docs/components-syn-option--docs
     * @status stable
     ...
     * @csspart prefix - The container that wraps the prefix.
     * @csspart suffix - The container that wraps the suffix.
     */ 'syn-option': SynIntrinsicElement<SynOption, SynOptionEvents>;
    /**
     * @summary <syn-pagination /> provides page navigation, direct page input, and page-size selection for large data sets.
     *
     * @documentation https://synergy-design-system.github.io/?path=/docs/components-syn-pagination--docs
     ...
     * Use the `aria-label` attribute to provide a unique, descriptive label when multiple pagination controls exist on the page.
     * Example: `<syn-pagination aria-label="Search results pagination"></syn-pagination>`
     */ 'syn-pagination': SynIntrinsicElement<
      SynPagination,
      SynPaginationEvents
    >;
    /**
     ...
     *  popup can be before overflowing. Useful for positioning child elements that need to overflow. This property is only
     *  available when using `auto-size`.
     */ 'syn-popup': SynIntrinsicElement<SynPopup, SynPopupEvents>;
    /**
     * @summary The `<syn-prio-nav />` element provides a generic navigation bar
     * that can be used to group multiple navigation items  (usually horizontal `<syn-nav-item />`s)
     * together. It will automatically group all items not visible in the viewport into a custom
     ...
     *    if there is not enough space.
     *
     */ 'syn-prio-nav': SynIntrinsicElement<SynPrioNav, SynPrioNavEvents>;
    /**
     * @summary Progress bars are used to show the status of an ongoing operation.
     * @documentation https://synergy-design-system.github.io/?path=/docs/components-syn-progress-bar--docs
     * @status stable
     ...
     * @cssproperty --label-color - The color of the label.
     * @cssproperty --speed - The speed of the progress bar when in indeterminate state.
     */ 'syn-progress-bar': SynIntrinsicElement<
      SynProgressBar,
      SynProgressBarEvents
    >;
    /**
     * @summary Progress rings are used to show the progress of a determinate operation in a circular fashion.
     * @documentation https://synergy-design-system.github.io/?path=/docs/components-syn-progress-ring--docs
     ...
     * @cssproperty --indicator-color - The color of the indicator.
     * @cssproperty --indicator-transition-duration - The duration of the indicator's transition when the value changes.
     */ 'syn-progress-ring': SynIntrinsicElement<
      SynProgressRing,
      SynProgressRingEvents
    >;
    /**
     ...
     * @csspart checked-icon - The checked icon, an `<syn-icon>` element.
     * @csspart label - The container that wraps the radio's label.
     */ 'syn-radio': SynIntrinsicElement<SynRadio, SynRadioEvents>;
    /**
     * @summary Radios buttons allow the user to select a single option from a group using a button-like control.
     * @documentation https://synergy-design-system.github.io/?path=/docs/components-syn-radio-button--docs
     * @status stable
     ...
     * @csspart label - The container that wraps the radio button's label.
     * @csspart suffix - The container that wraps the suffix.
     */ 'syn-radio-button': SynIntrinsicElement<
      SynRadioButton,
      SynRadioButtonEvents
    >;
    /**
     * @summary Radio groups are used to group multiple [radios](/components/radio) or [radio buttons](/components/radio-button) so they function as a single form control.
     * @documentation https://synergy-design-system.github.io/?path=/docs/components-syn-radio-group--docs
     ...
     * @csspart button-group - The button group that wraps radio buttons.
     * @csspart button-group__base - The button group's `base` part.
     */ 'syn-radio-group': SynIntrinsicElement<
      SynRadioGroup,
      SynRadioGroupEvents
    >;
    /**
     ...
     * @cssproperty --track-active-offset - The point of origin of the active track,
     * starting at the left side of the range.
     */ 'syn-range': SynIntrinsicElement<SynRange, SynRangeEvents>;
    /**
     * @summary Ticks visually improve positioning on range sliders.
     * @documentation https://synergy-design-system.github.io/?path=/docs/components-syn-range-tick--docs
     * @status stable
     ...
     * @cssproperty --tick-height - The height of the tick marker.
     * @cssproperty --tick-label-top - The top offset of the tick label.
     */ 'syn-range-tick': SynIntrinsicElement<SynRangeTick, SynRangeTickEvents>;
    /**
     * @summary Selects allow you to choose items from a menu of predefined options.
     * @documentation https://synergy-design-system.github.io/?path=/docs/components-syn-select--docs
     * @status stable
 ...
 * @animation sideNav.overlay.show - The animation to use when showing the side-nav's overlay.
 * @animation sideNav.overlay.hide - The animation to use when hiding the side-nav's overlay.
 */ 'syn-side-nav': SynIntrinsicElement<SynSideNav, SynSideNavEvents>;
    /**
     * @summary Spinners are used to show the progress of an indeterminate operation.
     * @documentation https://synergy-design-system.github.io/?path=/docs/components-syn-spinner--docs
     * @status stable
     ...
     * @cssproperty --indicator-color - The color of the spinner's indicator.
     * @cssproperty --speed - The time it takes for the spinner to complete one animation cycle.
     */ 'syn-spinner': SynIntrinsicElement<SynSpinner, SynSpinnerEvents>;
    /**
     * @summary Switches allow the user to toggle an option on or off.
     * @documentation https://synergy-design-system.github.io/?path=/docs/components-syn-switch--docs
     * @status stable
     ...
     * @cssproperty --height - The height of the switch.
     * @cssproperty --thumb-size - The size of the thumb.
     */ 'syn-switch': SynIntrinsicElement<SynSwitch, SynSwitchEvents>;
    /**
     * @summary Tabs are used inside [tab groups](/components/tab-group) to represent and activate [tab panels](/components/tab-panel).
     * @documentation https://synergy-design-system.github.io/?path=/docs/components-syn-tab--docs
     * @status stable
     ...
     * @csspart close-button - The close button, an `<syn-icon-button>`.
     * @csspart close-button__base - The close button's exported `base` part.
     */ 'syn-tab': SynIntrinsicElement<SynTab, SynTabEvents>;
    /**
     * @summary Tab groups organize content into a container that shows one section at a time.
     * @documentation https://synergy-design-system.github.io/?path=/docs/components-syn-tab-group--docs
     * @status stable
     ...
     * @cssproperty --track-width - The width of the indicator's track (the line that separates tabs from panels).
     * @cssproperty --indicator-width - The width of the active tab indicator.
     */ 'syn-tab-group': SynIntrinsicElement<SynTabGroup, SynTabGroupEvents>;
    /**
     * @summary Tab panels are used inside [tab groups](/components/tab-group) to display tabbed content.
     * @documentation https://synergy-design-system.github.io/?path=/docs/components-syn-tab-panel--docs
     * @status stable
     ...
     *
     * @cssproperty --padding - The tab panel's padding.
     */ 'syn-tab-panel': SynIntrinsicElement<SynTabPanel, SynTabPanelEvents>;
    /**
     * @summary Tags are used as labels to organize things or to indicate a selection.
     * @documentation https://synergy-design-system.github.io/?path=/docs/components-syn-tag--docs
     * @status stable
     ...
     * @csspart remove-button - The tag's remove button, an `<syn-icon-button>`.
     * @csspart remove-button__base - The remove button's exported `base` part.
     */ 'syn-tag': SynIntrinsicElement<SynTag, SynTagEvents>;
    /**
     * @summary A tag group is used to display multiple tags that belong together, often representing selected filters, categories, or user‑generated labels.
     * It arranges tags in flexible rows and supports different sizes and layouts.
     * Tags can be removable, icon‑based, or purely textual.
     ...
     * @csspart base - The component's base wrapper.
     * @csspart tag-label - The tag group's label.
     */ 'syn-tag-group': SynIntrinsicElement<SynTagGroup, SynTagGroupEvents>;
    /**
     * @summary Textareas collect data from the user and allow multiple lines of text.
     * @documentation https://synergy-design-system.github.io/?path=/docs/components-syn-textarea--docs
     * @status stable
     ...
     * @csspart base - The component's base wrapper.
     * @csspart textarea - The internal `<textarea>` control.
     */ 'syn-textarea': SynIntrinsicElement<SynTextarea, SynTextareaEvents>;
    /**
     * @summary Tooltips display additional information based on a specific action.
     * @documentation https://synergy-design-system.github.io/?path=/docs/components-syn-tooltip--docs
     * @status stable
     ...
     * @animation tooltip.show - The animation to use when showing the tooltip.
     * @animation tooltip.hide - The animation to use when hiding the tooltip.
     */ 'syn-tooltip': SynIntrinsicElement<SynTooltip, SynTooltipEvents>;
    /**
     * @summary Validate provides form field validation messages in a unified way.
     * It does this by using [the native browser validation](https://developer.mozilla.org/en-US/docs/Learn/Forms/Form_validation)
     * and showing the validation message in a consistent, user defined way.
     ...
     * @csspart tooltip__arrow - The container that wraps the tooltip arrow.
     * @csspart tooltip__body - The container that wraps the tooltip body.
     */ 'syn-validate': SynIntrinsicElement<SynValidate, SynValidateEvents>;
  }
}

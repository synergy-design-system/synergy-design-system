...
describe('<syn-textarea>', () => {
  it('should pass accessibility tests', async () => {
    const el = await fixture<SynTextarea>(html` <syn-textarea label="Name"></syn-textarea> `);
  ...
  it('should have title if title attribute is set', async () => {
    const el = await fixture<SynTextarea>(html` <syn-textarea title="Test"></syn-textarea> `);
  ...
  it('should be disabled with the disabled attribute', async () => {
    const el = await fixture<SynTextarea>(html` <syn-textarea disabled></syn-textarea> `);
  ...
  describe('when the value changes', () => {
    it('should emit syn-change and syn-input when the user types in the textarea', async () => {
      const el = await fixture<SynTextarea>(html` <syn-textarea></syn-textarea> `);
    ...
    it('should not emit syn-change or syn-input when calling setRangeText()', async () => {
      const el = await fixture<SynTextarea>(html` <syn-textarea value="hi there"></syn-textarea> `);
  ...
  describe('when using constraint validation', () => {
    ...
    it('should be invalid when required and empty', async () => {
      const el = await fixture<SynTextarea>(html` <syn-textarea required></syn-textarea> `);

      expect(el.checkValidity()).to.be.false;
    });

    it('should be invalid when required and after removing disabled ', async () => {
      const el = await fixture<SynTextarea>(html` <syn-textarea disabled required></syn-textarea> `);
    ...
    it('should receive the correct validation attributes ("states") when valid', async () => {
      const el = await fixture<SynTextarea>(html` <syn-textarea required value="a"></syn-textarea> `);
    ...
    it('should receive validation attributes ("states") even when novalidate is used on the parent form', async () => {
      const el = await fixture<HTMLFormElement>(html` <form novalidate><syn-textarea required></syn-textarea></form> `);
      const textarea = el.querySelector<SynTextarea>('syn-textarea')!;
  ...
  describe('when submitting a form', () => {
    it('should serialize its name and value with FormData', async () => {
      const form = await fixture<HTMLFormElement>(html` <form><syn-textarea name="a" value="1"></syn-textarea></form> `);
    ...
    it('should be invalid when setCustomValidity() is called with a non-empty value', async () => {
      const textarea = await fixture<HTMLFormElement>(html` <syn-textarea></syn-textarea> `);
    ...
    it('should be present in form data when using the form attribute and located outside of a <form>', async () => {
      const el = await fixture<HTMLFormElement>(html`
        <div>
          ...
          <syn-textarea form="f" name="a" value="1"></syn-textarea>
        </div>
      `);
  ...
  describe('when resetting a form', () => {
    it('should reset the element to its initial value', async () => {
      const form = await fixture<HTMLFormElement>(html`
        <form>
          <syn-textarea name="a" value="test"></syn-textarea>
  ...
  describe('when using spellcheck', () => {
    ...
    it('should enable spellcheck when set to "true"', async () => {
      const el = await fixture<SynTextarea>(html` <syn-textarea spellcheck="true"></syn-textarea> `);
      const textarea = el.shadowRoot!.querySelector<HTMLTextAreaElement>('textarea')!;
      expect(textarea.getAttribute('spellcheck')).to.equal('true');
      expect(textarea.spellcheck).to.be.true;
    });
    ...
    it('should disable spellcheck when set to "false"', async () => {
      const el = await fixture<SynTextarea>(html` <syn-textarea spellcheck="false"></syn-textarea> `);
      const textarea = el.shadowRoot!.querySelector<HTMLTextAreaElement>('textarea')!;
  ...
  describe('when using the setRangeText() function', () => {
    it('should set replacement text in the correct location', async () => {
      const el = await fixture<SynTextarea>(html` <syn-textarea value="test"></syn-textarea> `);
  ...
  runFormControlBaseTests('syn-textarea');
});

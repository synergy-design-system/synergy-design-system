...
import type SynBreadcrumbItem from './breadcrumb-item.js';

describe('<syn-breadcrumb-item>', () => {
  let el: SynBreadcrumbItem;

  describe('when not provided a href attribute', () => {
    before(async () => {
      el = await fixture<SynBreadcrumbItem>(html` <syn-breadcrumb-item>Home</syn-breadcrumb-item> `);
    });
  ...
  describe('when provided a href attribute', () => {
    describe('and no target', () => {
      before(async () => {
        el = await fixture<SynBreadcrumbItem>(html`
          <syn-breadcrumb-item href="https://jsonplaceholder.typicode.com/">Home</syn-breadcrumb-item>
        `);
      });
    ...
    describe('and target, without rel', () => {
      before(async () => {
        el = await fixture<SynBreadcrumbItem>(html`
          <syn-breadcrumb-item href="https://jsonplaceholder.typicode.com/" target="_blank">Help</syn-breadcrumb-item>
        `);
      });
    ...
    describe('and target, with rel', () => {
      before(async () => {
        el = await fixture<SynBreadcrumbItem>(html`
          <syn-breadcrumb-item href="https://jsonplaceholder.typicode.com/" target="_blank" rel="alternate"
            >Help</syn-breadcrumb-item
          >
        `);
      });

...
import '../../../components/src/components/chart-prop-partial/chart-prop-partial.js';
import {
...
const meta: Meta = {
  ...
  component: 'syn-chart-prop-partial',
  parameters: {
    chromatic: {
  ...
  title: 'Charts/Convenience API/Enhanced properties partial',
};
export default meta;
...
export const CyclicDataUpdate: Story = {
  ...
  render: () => html`
    <syn-chart-prop-partial id="chart-cyclic-data-update" palette="categorical"

 ...
 * @documentation https://sick.style/components/icon-button
 * @status stable
 * @since 2.0
 *
 * @dependency sds-icon
 *
 * @event sds-blur - Emitted when the icon button loses focus.
 * @event sds-focus - Emitted when the icon button gains focus.
 *
 * @csspart base - The component's base wrapper.
 */
export default class SdsIconButton extends SickElement {

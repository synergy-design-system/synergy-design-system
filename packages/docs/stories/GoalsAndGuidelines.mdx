...
The Synergy Design System, serves as a robust foundation for SICK's digital presence, built upon three core principles which should be kept in mind by designers, developers and stakeholders.

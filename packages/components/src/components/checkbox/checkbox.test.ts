...
import type SynCheckbox from './checkbox.js';

describe('<syn-checkbox>', () => {
  it('should pass accessibility tests', async () => {
    const el = await fixture<SynCheckbox>(html` <syn-checkbox>Checkbox</syn-checkbox> `);
  ...
  it('should have title if title attribute is set', async () => {
    const el = await fixture<SynCheckbox>(html` <syn-checkbox title="Test"></syn-checkbox> `);
  ...
  it('should be disabled with the disabled attribute', async () => {
    const el = await fixture<SynCheckbox>(html` <syn-checkbox disabled></syn-checkbox> `);
  ...
  it('should not emit syn-change or syn-input when checked programmatically', async () => {
    const el = await fixture<SynCheckbox>(html` <syn-checkbox></syn-checkbox> `);
  ...
  describe('when submitting a form', () => {
    it('should submit the correct value when a value is provided', async () => {
      const form = await fixture<HTMLFormElement>(html`
        <form>
          <syn-checkbox name="a" value="1" checked></syn-checkbox>
    ...
    it('should submit "on" when no value is provided', async () => {
      const form = await fixture<HTMLFormElement>(html`
        <form>
          <syn-checkbox name="a" checked></syn-checkbox>
          <syn-button type="submit">Submit</syn-button>
        </form>
      `);
      const button = form.querySelector('syn-button')!;
    ...
    it('should be invalid when required and unchecked', async () => {
      const checkbox = await fixture<HTMLFormElement>(html` <syn-checkbox required></syn-checkbox> `);
      expect(checkbox.checkValidity()).to.be.false;
    });

    it('should be valid when required and checked', async () => {
      const checkbox = await fixture<HTMLFormElement>(html` <syn-checkbox required checked></syn-checkbox> `);
    ...
    it('should be present in form data when using the form attribute and located outside of a <form>', async () => {
      const el = await fixture<HTMLFormElement>(html`
        <div>
          ...
          <syn-checkbox form="f" name="a" value="1" checked></syn-checkbox>
        </div>
      `);
    ...
    it('should receive validation attributes ("states") even when novalidate is used on the parent form', async () => {
      const el = await fixture<HTMLFormElement>(html` <form novalidate><syn-checkbox required></syn-checkbox></form> `);
      const checkbox = el.querySelector<SynCheckbox>('syn-checkbox')!;
  ...
  describe('focus', () => {
    ...
    it('should not jump the page to the bottom when focusing a checkbox at the bottom of an element with overflow: auto;', async () => {
      ...
      const checkboxes = el.querySelectorAll<SynCheckbox>('syn-checkbox');
  ...
  describe('indeterminate', () => {
    it('should render indeterminate icon until checked', async () => {
      const el = await fixture<SynCheckbox>(html`<syn-checkbox indeterminate></syn-checkbox>`);
    ...
    runFormControlBaseTests('syn-checkbox');
  });
});

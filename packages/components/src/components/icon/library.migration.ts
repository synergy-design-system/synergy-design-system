...
export const getIconMigrationName = (iconName: string) => {
  ...
  case 'announcement': return 'sms_failed';
  ...
  case 'bluetooth_audio': return 'bluetooth';
  ...
  case 'camera_alt': return 'camera';
  case 'cancel_outline': return 'cancel';
  case 'card_giftcard': return 'featured_seasonal_and_gifts';
  ...
  case 'class': return 'MISSING';
  case 'clear': return 'close';
  case 'closed_caption_off': return 'closed_caption';
  case 'collections': return 'collections_bookmark';
  ...
  case 'crop_original': return 'wallpaper';
  case 'data_saver_off': return 'MISSING';
  ...
  case 'discount': return 'MISSING';
  case 'do_disturb': return 'do_not_disturb_off';
  case 'do_disturb_alt': return 'do_not_disturb_on';
  case 'do_disturb_off': return 'do_not_disturb_on';
  ...
  case 'emoji_emotions': return 'sentiment_satisfied';
  ...
  case 'import_export': return 'height';
  case 'info_outline': return 'info';
  case 'insert_chart_outlined': return 'add_chart';
  case 'insert_comment': return 'comment';
  case 'insert_drive_file': return 'note';
  case 'insert_emoticon': return 'sentiment_satisfied';
  case 'insert_invitation': return 'event';
  case 'insert_link': return 'link';
  case 'insert_photo': return 'wallpaper';
  case 'iso': return 'MISSING';
  ...
  case 'local_offer': return 'loyalty';
  ...
  case 'markunread': return 'markunread_mailbox';
  case 'message': return 'chat';
  case 'mic_none': return 'mic_off';
  case 'miscellaneous_services': return 'settings';
  ...
  case 'no_cell': return 'MISSING';
  case 'no_encryption_gmailerrorred': return 'no_encryption';
  case 'not_interested': return 'hide_source';
  case 'notifications_none': return 'notifications';
  case 'ondemand_video': return 'play_circle';
  case 'outlined_flag': return 'emoji_flags';
  ...
  case 'pause_circle_filled': return 'null';
  ...
  case 'photo_size_select_actual': return 'wallpaper';
  ...
  case 'poll': return 'ballot';
  case 'portrait': return 'account_box';
  case 'progress_activity_outline': return 'progress_activity';
  case 'query_builder': return 'alarm';
  case 'question_answer': return 'forum';
  case 'queue': return 'add_to_queue';
  case 'remove_circle': return 'do_not_disturb_on_total_silence';
  case 'remove_circle_outline': return 'do_not_disturb_on_total_silence';
  case 'remove_red_eye': return 'visibility';
  case 'replay_circle_filled': return 'replay';
  case 'report_gmailerrorred': return 'dangerous';
  ...
  case 'security_update': return 'install_mobile';
  ...
  case 'signal_cellular_no_sim': return 'sd_card_alert';
  case 'signal_wifi_4_bar_lock': return 'MISSING';
  ...
  case 'star_border_purple500': return 'grade';
  case 'star_outline': return 'star';
  case 'star_purple500': return 'grade';
  case 'stop_circle_outline': return 'stop_circle';
  case 'store_mall_directory': return 'mall';
  case 'system_security_update': return 'install_mobile';
  case 'system_security_update_good': return 'MISSING';
  case 'system_security_update_warning': return 'perm_device_information';

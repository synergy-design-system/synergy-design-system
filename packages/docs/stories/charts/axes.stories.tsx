...
export const AxesValuesHidden: Story = {
  ...
  render: () => html`
    ...
    <script type="module">
        // preview-ignore:start
        import { enhanceConfig, hideAxesValues } from '../node_modules/@synergy-design-system/components/dist/components/chart/configs/index.js';
        // preview-ignore:end
...
export const AxesLinesVisibleWithValuesHidden: Story = {
  ...
  render: () => html`
      ...
      <script type="module">
        // preview-ignore:start
        import { enhanceConfig, hideAxesValues, showGridLines } from '../node_modules/@synergy-design-system/components/dist/components/chart/configs/index.js';
        // preview-ignore:end
        const baseConfig = {
          series: [{ data: [150, 230, 224, 218, 135, 147, 260], type: 'line' }],
          xAxis: {

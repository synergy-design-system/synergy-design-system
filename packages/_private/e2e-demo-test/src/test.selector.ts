...
export default {
  ...
  preferredContactEmail: '#preferred-contact-method syn-radio-button:nth-of-type(1)',
  preferredContactLoc: '#preferred-contact-method',
  preferredContactPhone: '#preferred-contact-method syn-radio-button:nth-of-type(2)',

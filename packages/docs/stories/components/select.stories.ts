...
export const Labels: Story = {
  render: () => html`<syn-select label="Select one">
...
export const HelpText: Story = {
  render: () => html`<syn-select label="Experience" help-text="Please tell us your skill level.">
...
export const Placeholders: Story = {
  render: () => html`<syn-select placeholder="Select one">
  <syn-option value="option-1">Option 1</syn-option>
  <syn-option value="option-2">Option 2</syn-option>
  <syn-option value="option-3">Option 3</syn-option>
</syn-select>`,
...
export const Clearable: Story = {
  render: () => html`<syn-select clearable value="option-1">
  <syn-option value="option-1">Option 1</syn-option>
  <syn-option value="option-2">Option 2</syn-option>
  <syn-option value="option-3">Option 3</syn-option>
</syn-select>`,
...
export const Disabled: Story = {
  render: () => html`<syn-select placeholder="Disabled" disabled>
  <syn-option value="option-1">Option 1</syn-option>
  <syn-option value="option-2">Option 2</syn-option>
  <syn-option value="option-3">Option 3</syn-option>
</syn-select>`,
...
export const Multiple: Story = {
  render: () => html`<syn-select label="Select a Few" value="option-1 option-2 option-3" multiple clearable>
  <syn-option value="option-1">Option 1</syn-option>
  <syn-option value="option-2">Option 2</syn-option>
  <syn-option value="option-3">Option 3</syn-option>
...
export const SettingInitialValues: Story = {
  render: () => html`<syn-select value="option-1 option-2" multiple clearable>
  <syn-option value="option-1">Option 1</syn-option>
  <syn-option value="option-2">Option 2</syn-option>
  <syn-option value="option-3">Option 3</syn-option>
  <syn-option value="option-4">Option 4</syn-option>
...
export const Sizes: Story = {
  render: () => html`<syn-select placeholder="Small" size="small">
  <syn-option value="option-1">Option 1</syn-option>
  <syn-option value="option-2">Option 2</syn-option>
  <syn-option value="option-3">Option 3</syn-option>
</syn-select>
...
export const Placement: Story = {
  render: () => html`<syn-select placement="top">
  <syn-option value="option-1">Option 1</syn-option>
  <syn-option value="option-2">Option 2</syn-option>
  <syn-option value="option-3">Option 3</syn-option>
</syn-select>`,
...
export const PrefixIcons: Story = {
  render: () => html`<syn-select placeholder="Small" size="small" clearable>

...
import '../../../components/src/components/chart/chart-partial.js';
...
const meta: Meta = {
    ...
    docs: {
      description: {
        component:
          [
            '>⚠️ **Experimental**:',
            '>syn-chart-partial is currently experimental.',
  ...
  title: 'Charts/Convenience API/Sub components - Partial',
};
export default meta;
...
export const MultipleSeries: Story = {
  ...
  render: () => html`
    <syn-chart-partial .config=${{ legend: { show: true } }}>
      <syn-chart-axis axis="x" .data=${['Mon', 'Tue', 'Wed', 'Thu', 'Fri']}></syn-chart-axis>
      <syn-chart-axis axis="y" type="value"></syn-chart-axis>
      <syn-chart-series type="line" name="Revenue" .data=${[120, 160, 140, 210, 240]}></syn-chart-series>
...
export const InconsistentDataLengths: Story = {
  ...
  render: () => html`
    <syn-chart-partial id="chart-convenience-sub-inconsistent" palette="sequential-05">
...
export const CyclicDataUpdate: Story = {
  ...
  render: () => html`
    <syn-chart-partial id="chart-convenience-sub-cyclic" palette="categorical">
      <syn-chart-axis axis="y" type="value"></syn-chart-axis>

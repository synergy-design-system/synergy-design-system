 ...
 */
  @Input()
  set optionLayout(v: SynRadioGroup['optionLayout']) {
    this._ngZone.runOutsideAngular(() => (this.nativeElement.optionLayout = v));
  }
  get optionLayout(): SynRadioGroup['optionLayout'] {
    return this.nativeElement.optionLayout;
  }

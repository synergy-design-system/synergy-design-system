...
export const vendorTextarea = (path, content) => {
  ...
  // output.content = removeSection(output.content, "'textarea--pill':", ',');
  ...
  // output.content = output.content.replace(/syn-textarea/g, 'syn-textarea');
  // output.content = output.content.replace(/syn-checkbox/g, 'syn-textarea');

...
describe('<syn-drawer>', () => {
  it('should be visible with the open attribute', async () => {
    const el = await fixture<SynDrawer>(html`
      <syn-drawer open>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</syn-drawer>
    `);
  ...
  it('should not be visible without the open attribute', async () => {
    const el = await fixture<SynDrawer>(html`
      <syn-drawer>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</syn-drawer>
    `);
    const base = el.shadowRoot!.querySelector<HTMLElement>('[part~="base"]')!;
  ...
  it('should allow initial focus to be set', async () => {
    const el = await fixture<SynDrawer>(html` <syn-drawer><input /></syn-drawer> `);

...
Each metadata object requires a `name` property and optionally accepts a `description`. Run `pnpm build` to process the metadata and automatically add JSDoc annotations to your component's class comment.

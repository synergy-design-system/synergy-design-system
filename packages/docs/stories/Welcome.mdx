...
## Getting started 🛫
<div style={{display:"flex", alignItems:"center"}}><img src="/vanilla.webp" height="50"></img> with vanilla JS:&nbsp;[click here](../?path=/docs/packages-components-web-components--docs) <br/></div>

...
const main = async () => {
  ...
  const command = await select({
    ...
    options: [
      ...
      { value: 'tokens', label: 'Update Tokens', hint: 'This will create the themes for your tokens.' },
      { value: 'reset', label: 'Reset Shoelace', hint: 'This will automatically regenerate your Shoelace files, too.' },
    ],
  });

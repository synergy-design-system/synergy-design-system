...
const nativeElement = ref<SynAutocomplete>();
 ...
 */
  'value'?: SynAutocomplete['value'];

  /**
* The select's size.
 */
  'size'?: SynAutocomplete['size'];

  /**
* Placeholder text to show as a hint when the select is empty.
 */
  'placeholder'?: SynAutocomplete['placeholder'];

  /**
* Disables the select control.
 */
  'disabled'?: SynAutocomplete['disabled'];

  /**
* Adds a clear button when the select is not empty.
 */
  'clearable'?: SynAutocomplete['clearable'];
 ...
 */
  'hoist'?: SynAutocomplete['hoist'];

  /**
* The select's label.
* If you need to display HTML, use the `label` slot instead.
 */
  'label'?: SynAutocomplete['label'];
 ...
 */
  'placement'?: SynAutocomplete['placement'];

  /**
* The select's help text.
* If you need to display HTML, use the `help-text` slot instead.
 */
  'helpText'?: SynAutocomplete['helpText'];

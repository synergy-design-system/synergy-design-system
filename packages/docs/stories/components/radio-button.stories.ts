...
export const Sizes: Story = {
  ...
  render: () => html`
    ${['small', 'medium', 'large'].map(size => html`
      <syn-radio-group label="Select an option" name="size-${size}" value="1" style="margin-bottom: 16px;">
        <syn-radio-button value="1" size=${size}>Option 1</syn-radio-button>
        <syn-radio-button value="2" size=${size}>Option 2</syn-radio-button>
        <syn-radio-button value="3" size=${size}>Option 3</syn-radio-button>
      </syn-radio-group>
    `)}
  `,
};
